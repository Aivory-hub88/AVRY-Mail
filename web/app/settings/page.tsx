      ...
      <div className="mx-auto max-w-4xl p-6">
        ...
        <div className="mt-4 rounded-2xl border border-[#f0ece0] bg-[#fefcf6] p-5 shadow-sm">
          ...
          <div className="mt-3 flex gap-2">
            ...
            <button className="rounded-lg bg-[#005a5e] px-5 py-2 text-sm font-medium text-white hover:bg-black">Apply</button>
          </div>
        </div>
        ...
        <div className="mt-4 rounded-2xl border border-[#f0ece0] bg-[#fefcf6] p-5 shadow-sm">
          ...
          <div className="mt-4 flex flex-wrap items-center gap-3">
            ...
            <button onClick={generate} className="inline-flex items-center gap-2 rounded-lg bg-[#005a5e] px-5 py-2.5 text-sm font-semibold text-white hover:bg-black">
        ...
        <div className="mt-4 flex items-center justify-between rounded-2xl border border-[#f0ece0] bg-[#fefcf6] p-4">
          ...
          <a href="mailto:hello@aivory.uk" className="rounded-lg bg-[#005a5e] px-5 py-2.5 text-sm font-semibold text-white">Contact us</a>
        </div>
