...
impl Config {
    pub fn from_env() -> Self {
        ...
        Self {
            ...
            mail_admin_email: env::var("MAIL_ADMIN_EMAIL").unwrap_or_else(|_| "irfan.reichmann@aivory.uk".into()),
            mail_admin_password: env::var("MAIL_ADMIN_PASSWORD").unwrap_or_default(),
